...
self.onmessage = function(e) {
    ...
    try {
        ...
        if (type === 'buildBoth' && Array.isArray(enemyNavGrid)) {
            const enemyPolys = (0, _buildPolysFromGridMapJs.buildPolysFromGridMap)(enemyNavGrid, (0, _constantsJs.SQUARESIZE), (0, _constantsJs.SQUARESIZE), undefined, 0);
            self.postMessage({
                success: true,
                requestId,
                polys,
...
},{"./UI/UIConstants":"6S8ZK","./parcelController/StageState":"fb4wq","@parcel/transformer-js/src/esmodule-helpers.js":"fn8Fk"}],"6S8ZK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
